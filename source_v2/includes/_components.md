...
- ``global`` – special mode for components from the standard set of components of {{ product_name }} Platform (e.g. ``timer``, ``webhook`` etc). Any user of the platform can use ``global`` components.
